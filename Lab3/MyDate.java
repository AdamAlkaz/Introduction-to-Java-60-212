import java.util.*;
	...
	public class MyDate {
		...
		public String toString(){
			...
			//returns the word of the month, the day and the last two characters of the year
			return (toStringDate + day + ", '" + yearToken.substring(2));
		}
		public boolean lessThan(MyDate d){
			//checks all possible scenarios if the current year class is before the entered one
		...
		public boolean equals (MyDate d){
			//if all values are equal the dates are equal
